...
export default function PlenariaApp() {
  ...
  />
      ...
      {!planilhaCarregada ? (
  <div className="space-y-4 max-w-2xl bg-gray-800 rounded p-6 mx-auto text-center">
...
<div className="flex flex-row flex-wrap justify-center items-center space-x-2 max-w-7xl bg-gray-900 rounded-lg p-2 mx-auto">
  {processosRestantes.map((proc) => (
    <Button
      key={proc.id}
      className=" font-bold border-2 px-4 py-2 bg-gray-950 hover:bg-slate-500 text-stone-950 transition"

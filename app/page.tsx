  ...
  />
      ...
      {!planilhaCarregada ? (
        <div className="space-y-2 max-w-2xl bg-gray-900 rounded p-4 mx-auto">
          ...
          <input type="file" accept=".xlsx, .xls" onChange={handleUpload} className="p-1 border rounded w-full bg-gray-700 text-gray-700" />
        </div>
      ) : !autenticado ? (
...
<div className="flex flex-row flex-wrap justify-center items-center space-x-2 max-w-7xl bg-gray-900 rounded-lg p-2 mx-auto">
  {processosRestantes.map((proc) => (
    <Button
      key={proc.id}
      className="border-2 px-4 py-2 bg-gray-950 hover:bg-cyan-950 "

...
export default function PlenariaApp() {
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-900 min-h-screen text-white">
      <h1 className="text-4xl font-extrabold text-center mb-4"> TRIBUNAL ADMINISTRATIVO DE RECURSOS AMBIENTAIS </h1>
...
<div className="flex flex-row flex-wrap justify-center items-center space-x-2 max-w-7xl bg-gray-800 shadow-md rounded-lg p-2 mx-auto">
                  ...
                  {mostrarMotivo && (
                    <div className="bg-gray-100 p-4 rounded text-black">
                      ...
                      <div className="mt-4 flex space-x-4">
                        ...
                        <Button className="flex-1" variant="bg-white-500 hover:bg-white-600 text-white font-bold py-2 px-4 rounded-full" onClick={() => setMostrarMotivo(false)}>
                          Cancelar
                        </Button>
                      </div>
                    </div>
